...
import PlacesAutocompleteFormic from '../src/components/PlacesAutocompleteFormic.jsx'
...
const validationSchema = yup.object({
  autocomplete: yup.string().typeError('age must be a number'),
})
              ...
              >
                ...
                <Grid item xs={12}>
                  ...
                  <Field
                    name="autocomplete"
                    id="autocomplete"
                    component={PlacesAutocompleteFormic}
                  />
                </Grid>
