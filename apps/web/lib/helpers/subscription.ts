export const subscriptionConfig = {
  ...
  wasteRemoval: {
    ...
    description: `Подписка предназначена для тех, кто хочет сдать вторсырье на переработку, но поблизости нет пунктов приема. После активации подписки, система будет производить поиск пунктов приема тех видов вторсырья, которые указаны в ваших объявлениях о наличии вторсырья. Поиск будет производиться в указанном вами радиусе. При появлении новых пунктов приема, вы получите уведомление на электронную почту.`,
